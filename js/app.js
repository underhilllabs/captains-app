this.CaptainCtrl = function ($scope) {
  $scope.captains = [
    ...
    , {"name": "Kathryn Janeway", "image": "img/janeway.jpg", "source": "Star Trek Voyager ", "votes": 0}
    , {"name": "Hikaru Sulu", "image": "img/sulu.jpg", "source": "Star Trek Movies", "votes": 6}
    , {"name": "Mal Reynolds","image": "img/mal.jpg", "source": "Firefly", "votes": 4}
